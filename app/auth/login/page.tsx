...
import { signInAndGetRole, supabase } from "../../../lib/supabaseClient"
...
export default function LoginPage() {
  ...
  const onSubmit = async () => {
    ...
    try {
      ...
      // ✅ Wait until Supabase confirms session cookies are synced
      ...
      if (!sessionReady) {
        console.warn("⚠️ Session not ready, forcing hard reload.")
